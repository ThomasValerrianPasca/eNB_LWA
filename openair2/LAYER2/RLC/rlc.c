...
//    }
//
//    void get_data(mem_block_t *new_sdu_p,sdu_size_t sdu_sizeP )
////      void get_data()
//    {
...
//    }
//
//    void get_udp(mem_block_t *new_sdu_p,sdu_size_t sdu_sizeP )
////    void get_udp()
//    {
...
//    }
//
//    void get_ip(mem_block_t *new_sdu_p,sdu_size_t sdu_sizeP )
////    void get_ip()
//    {
//
...
//    	iph->saddr	= inet_addr("192.168.130.25");
//
//    	iph->daddr	= inet_addr("192.168.130.171"); // put destination IP address
//
//
...
//
//    }
//    void send_wifi(mem_block_t *new_sdu_p,sdu_size_t sdu_sizeP )
//    ///void send_wifi()
//    {
//
...
//
//        	       	printf("sdu size ######%d", sdu_sizeP);
//        	       	int val=0;
//        	       	printf("Data !!!!!!!!!!!!!!!");
//        	for (val=0; val<sdu_sizeP;val++)
//        	       	printf("%.2X\n",*(new_sdu_p->data+val));
//
//        	send_wifi(temp,sdu_sizeP);
//        	//send_wifi();
//        	printf("Himank Sent \n");
//        	return RLC_OP_STATUS_OK;
//        }
      ...
      // printf("Data !!!!!!!!!!!!!!!% .2X\n",new_sdu_p->data);
//        printf("Size %d\n",sdu_sizeP);
// Steering the traffic across LTE and Wi-Fi



//        printf("Packet THrough LTE......\n");
