...
static asn_per_constraints_t asn_PER_type_X2ap_MeasurementThresholdA2_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  1,  1,  0,  1 }	/* (0..1,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_X2ap_MeasurementThresholdA2_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_X2ap_MeasurementThresholdA2_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* threshold-RSRP at 846 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* threshold-RSRQ at 847 */
};
static asn_CHOICE_specifics_t asn_SPC_X2ap_MeasurementThresholdA2_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_X2ap_MeasurementThresholdA2 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_X2ap_MeasurementThresholdA2_constr_1,
