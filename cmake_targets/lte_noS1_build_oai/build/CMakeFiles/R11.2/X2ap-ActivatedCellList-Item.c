...
static asn_TYPE_member_t asn_MBR_X2ap_ActivatedCellList_Item_1[] = {
...
static int asn_MAP_X2ap_ActivatedCellList_Item_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_X2ap_ActivatedCellList_Item_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_X2ap_ActivatedCellList_Item_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ecgi at 71 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* iE-Extensions at 73 */
};
static asn_SEQUENCE_specifics_t asn_SPC_X2ap_ActivatedCellList_Item_specs_1 = {
