...
static asn_TYPE_member_t asn_MBR_X2ap_AllocationAndRetentionPriority_1[] = {
...
static int asn_MAP_X2ap_AllocationAndRetentionPriority_oms_1[] = { 3 };
static ber_tlv_tag_t asn_DEF_X2ap_AllocationAndRetentionPriority_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_X2ap_AllocationAndRetentionPriority_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* priorityLevel at 139 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* pre-emptionCapability at 140 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* pre-emptionVulnerability at 141 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* iE-Extensions at 143 */
};
static asn_SEQUENCE_specifics_t asn_SPC_X2ap_AllocationAndRetentionPriority_specs_1 = {
