...
static asn_TYPE_member_t asn_MBR_X2ap_CompositeAvailableCapacityGroup_1[] = {
...
static int asn_MAP_X2ap_CompositeAvailableCapacityGroup_oms_1[] = { 2 };
static ber_tlv_tag_t asn_DEF_X2ap_CompositeAvailableCapacityGroup_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_X2ap_CompositeAvailableCapacityGroup_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dL-CompositeAvailableCapacity at 299 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* uL-CompositeAvailableCapacity at 300 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* iE-Extensions at 302 */
};
static asn_SEQUENCE_specifics_t asn_SPC_X2ap_CompositeAvailableCapacityGroup_specs_1 = {
