...
static asn_TYPE_member_t asn_MBR_X2ap_TDD_Info_1[] = {
...
static int asn_MAP_X2ap_TDD_Info_oms_1[] = { 4 };
static ber_tlv_tag_t asn_DEF_X2ap_TDD_Info_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_X2ap_TDD_Info_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* eARFCN at 446 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* transmission-Bandwidth at 447 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* subframeAssignment at 448 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* specialSubframe-Info at 449 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* iE-Extensions at 451 */
};
static asn_SEQUENCE_specifics_t asn_SPC_X2ap_TDD_Info_specs_1 = {
