...
static asn_per_constraints_t asn_PER_type_X2ap_CriticalityDiagnostics_IE_List_constr_1 GCC_NOTUSED = {
...
static asn_TYPE_tag2member_t asn_MAP_Member_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* iECriticality at 375 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* iE-ID at 376 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* typeOfError at 377 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* iE-Extensions at 379 */
};
...
static asn_TYPE_member_t asn_MBR_X2ap_CriticalityDiagnostics_IE_List_1[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_Member_2,
...
static ber_tlv_tag_t asn_DEF_X2ap_CriticalityDiagnostics_IE_List_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_X2ap_CriticalityDiagnostics_IE_List_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_X2ap_CriticalityDiagnostics_IE_List = {
	...
	sizeof(asn_DEF_X2ap_CriticalityDiagnostics_IE_List_tags_1)
		/sizeof(asn_DEF_X2ap_CriticalityDiagnostics_IE_List_tags_1[0]), /* 1 */
	&asn_PER_type_X2ap_CriticalityDiagnostics_IE_List_constr_1,
