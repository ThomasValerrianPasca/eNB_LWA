...
asn_comp_rval_t * 
S1ap_CNDomain_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	S1ap_CNDomain_1_inherit_TYPE_descriptor(td1);
	S1ap_CNDomain_1_inherit_TYPE_descriptor(td2);
...
static asn_INTEGER_enum_map_t asn_MAP_S1ap_CNDomain_value2enum_1[] = {
	{ 0,	2,	"ps" },
	{ 1,	2,	"cs" }
};
static unsigned int asn_MAP_S1ap_CNDomain_enum2value_1[] = {
	1,	/* cs(1) */
	0	/* ps(0) */
};
static asn_INTEGER_specifics_t asn_SPC_S1ap_CNDomain_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_S1ap_CNDomain_tags_1[] = {
