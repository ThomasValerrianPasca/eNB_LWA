...
static asn_per_constraints_t asn_PER_type_S1ap_E_RABToBeSwitchedULList_constr_1 GCC_NOTUSED = {
...
static ber_tlv_tag_t asn_DEF_S1ap_E_RABToBeSwitchedULList_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
