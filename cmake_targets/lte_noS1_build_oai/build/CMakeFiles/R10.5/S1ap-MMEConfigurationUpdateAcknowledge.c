...
static ber_tlv_tag_t asn_DEF_s1ap_MMEConfigurationUpdateAcknowledge_ies_tags_2[] = {
...
static ber_tlv_tag_t asn_DEF_S1ap_MMEConfigurationUpdateAcknowledge_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_S1ap_MMEConfigurationUpdateAcknowledge_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* s1ap-MMEConfigurationUpdateAcknowledge-ies at 237 */
};
