...
asn_comp_rval_t * 
S1ap_CauseMisc_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	S1ap_CauseMisc_1_inherit_TYPE_descriptor(td1);
	S1ap_CauseMisc_1_inherit_TYPE_descriptor(td2);
...
static asn_INTEGER_enum_map_t asn_MAP_S1ap_CauseMisc_value2enum_1[] = {
...
static unsigned int asn_MAP_S1ap_CauseMisc_enum2value_1[] = {
...
static asn_INTEGER_specifics_t asn_SPC_S1ap_CauseMisc_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_S1ap_CauseMisc_tags_1[] = {
