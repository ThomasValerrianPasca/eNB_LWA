 ...
 * Created on: 2018-04-01 22:01:06.951659 by root
...
int s1ap_encode_s1ap_initialuemessageies(
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_eNB_UE_S1AP_ID,
                        S1ap_Criticality_reject,
                        &asn_DEF_S1ap_ENB_UE_S1AP_ID,
                          &s1ap_InitialUEMessageIEs->eNB_UE_S1AP_ID)) == NULL) {
        return -1;
    }
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_NAS_PDU,
                        ...
                        &asn_DEF_S1ap_NAS_PDU,
                          &s1ap_InitialUEMessageIEs->nas_pdu)) == NULL) {
        return -1;
    }
    ASN_SEQUENCE_ADD(&s1ap_InitialUEMessage->s1ap_InitialUEMessage_ies.list, ie);
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_TAI,
                        S1ap_Criticality_reject,
                        &asn_DEF_S1ap_TAI,
                          &s1ap_InitialUEMessageIEs->tai)) == NULL) {
        return -1;
    }
    ASN_SEQUENCE_ADD(&s1ap_InitialUEMessage->s1ap_InitialUEMessage_ies.list, ie);
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_EUTRAN_CGI,
                        ...
                        &asn_DEF_S1ap_EUTRAN_CGI,
                          &s1ap_InitialUEMessageIEs->eutran_cgi)) == NULL) {
        return -1;
    }
    ASN_SEQUENCE_ADD(&s1ap_InitialUEMessage->s1ap_InitialUEMessage_ies.list, ie);
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_RRC_Establishment_Cause,
                        ...
                        &asn_DEF_S1ap_RRC_Establishment_Cause,
                          &s1ap_InitialUEMessageIEs->rrC_Establishment_Cause)) == NULL) {
        return -1;
    }
    ASN_SEQUENCE_ADD(&s1ap_InitialUEMessage->s1ap_InitialUEMessage_ies.list, ie);
    ...
    if (s1ap_InitialUEMessageIEs->presenceMask & S1AP_INITIALUEMESSAGEIES_S_TMSI_PRESENT) {
        if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_S_TMSI,
                            S1ap_Criticality_reject,
                            &asn_DEF_S1ap_S_TMSI,
                            &s1ap_InitialUEMessageIEs->s_tmsi)) == NULL) {
            return -1;
        }
        ASN_SEQUENCE_ADD(&s1ap_InitialUEMessage->s1ap_InitialUEMessage_ies.list, ie);
    }
    ...
    if (s1ap_InitialUEMessageIEs->presenceMask & S1AP_INITIALUEMESSAGEIES_CSG_ID_PRESENT) {
        if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_CSG_Id,
                            S1ap_Criticality_reject,
                            &asn_DEF_S1ap_CSG_Id,
                            &s1ap_InitialUEMessageIEs->csG_Id)) == NULL) {
            return -1;
        }
        ASN_SEQUENCE_ADD(&s1ap_InitialUEMessage->s1ap_InitialUEMessage_ies.list, ie);
    }
    ...
    if (s1ap_InitialUEMessageIEs->presenceMask & S1AP_INITIALUEMESSAGEIES_GUMMEI_ID_PRESENT) {
        if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_GUMMEI_ID,
                            S1ap_Criticality_reject,
                            &asn_DEF_S1ap_GUMMEI,
                            &s1ap_InitialUEMessageIEs->gummei_id)) == NULL) {
            return -1;
        }
        ASN_SEQUENCE_ADD(&s1ap_InitialUEMessage->s1ap_InitialUEMessage_ies.list, ie);
    }
    ...
    if (s1ap_InitialUEMessageIEs->presenceMask & S1AP_INITIALUEMESSAGEIES_CELLACCESSMODE_PRESENT) {
        if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_CellAccessMode,
                            ...
                            &s1ap_InitialUEMessageIEs->cellAccessMode)) == NULL) {
            return -1;
        }
        ASN_SEQUENCE_ADD(&s1ap_InitialUEMessage->s1ap_InitialUEMessage_ies.list, ie);
    }
    ...
    if (s1ap_InitialUEMessageIEs->presenceMask & S1AP_INITIALUEMESSAGEIES_GW_TRANSPORTLAYERADDRESS_PRESENT) {
        if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_GW_TransportLayerAddress,
                            ...
                            &s1ap_InitialUEMessageIEs->gW_TransportLayerAddress)) == NULL) {
            return -1;
        }
        ASN_SEQUENCE_ADD(&s1ap_InitialUEMessage->s1ap_InitialUEMessage_ies.list, ie);
    }
    ...
    if (s1ap_InitialUEMessageIEs->presenceMask & S1AP_INITIALUEMESSAGEIES_RELAYNODE_INDICATOR_PRESENT) {
        if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_RelayNode_Indicator,
                            ...
                            &s1ap_InitialUEMessageIEs->relayNode_Indicator)) == NULL) {
            return -1;
        }
        ASN_SEQUENCE_ADD(&s1ap_InitialUEMessage->s1ap_InitialUEMessage_ies.list, ie);
    }
...
int s1ap_encode_s1ap_downlinknastransporties(
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_MME_UE_S1AP_ID,
                        S1ap_Criticality_reject,
                        &asn_DEF_S1ap_MME_UE_S1AP_ID,
                          &s1ap_DownlinkNASTransportIEs->mme_ue_s1ap_id)) == NULL) {
        return -1;
    }
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_eNB_UE_S1AP_ID,
                        S1ap_Criticality_reject,
                        &asn_DEF_S1ap_ENB_UE_S1AP_ID,
                          &s1ap_DownlinkNASTransportIEs->eNB_UE_S1AP_ID)) == NULL) {
        return -1;
    }
    ASN_SEQUENCE_ADD(&s1ap_DownlinkNASTransport->s1ap_DownlinkNASTransport_ies.list, ie);
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_NAS_PDU,
                        S1ap_Criticality_reject,
                        &asn_DEF_S1ap_NAS_PDU,
                          &s1ap_DownlinkNASTransportIEs->nas_pdu)) == NULL) {
        return -1;
    }
    ASN_SEQUENCE_ADD(&s1ap_DownlinkNASTransport->s1ap_DownlinkNASTransport_ies.list, ie);
    ...
    if (s1ap_DownlinkNASTransportIEs->presenceMask & S1AP_DOWNLINKNASTRANSPORTIES_HANDOVERRESTRICTIONLIST_PRESENT) {
        if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_HandoverRestrictionList,
                            S1ap_Criticality_ignore,
                            &asn_DEF_S1ap_HandoverRestrictionList,
                            &s1ap_DownlinkNASTransportIEs->handoverRestrictionList)) == NULL) {
            return -1;
        }
        ASN_SEQUENCE_ADD(&s1ap_DownlinkNASTransport->s1ap_DownlinkNASTransport_ies.list, ie);
    }
    ...
    if (s1ap_DownlinkNASTransportIEs->presenceMask & S1AP_DOWNLINKNASTRANSPORTIES_SUBSCRIBERPROFILEIDFORRFP_PRESENT) {
        if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_SubscriberProfileIDforRFP,
                            S1ap_Criticality_ignore,
                            &asn_DEF_S1ap_SubscriberProfileIDforRFP,
                            &s1ap_DownlinkNASTransportIEs->subscriberProfileIDforRFP)) == NULL) {
            return -1;
        }
        ASN_SEQUENCE_ADD(&s1ap_DownlinkNASTransport->s1ap_DownlinkNASTransport_ies.list, ie);
    }
...
int s1ap_encode_s1ap_uecontextreleasecompleteies(
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_MME_UE_S1AP_ID,
                        S1ap_Criticality_ignore,
                        &asn_DEF_S1ap_MME_UE_S1AP_ID,
                          &s1ap_UEContextReleaseCompleteIEs->mme_ue_s1ap_id)) == NULL) {
        return -1;
    }
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_eNB_UE_S1AP_ID,
                        S1ap_Criticality_ignore,
                        &asn_DEF_S1ap_ENB_UE_S1AP_ID,
                          &s1ap_UEContextReleaseCompleteIEs->eNB_UE_S1AP_ID)) == NULL) {
        return -1;
    }
    ASN_SEQUENCE_ADD(&s1ap_UEContextReleaseComplete->s1ap_UEContextReleaseComplete_ies.list, ie);
    ...
    if (s1ap_UEContextReleaseCompleteIEs->presenceMask & S1AP_UECONTEXTRELEASECOMPLETEIES_CRITICALITYDIAGNOSTICS_PRESENT) {
        if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_CriticalityDiagnostics,
                            S1ap_Criticality_ignore,
                            &asn_DEF_S1ap_CriticalityDiagnostics,
                            &s1ap_UEContextReleaseCompleteIEs->criticalityDiagnostics)) == NULL) {
            return -1;
        }
        ASN_SEQUENCE_ADD(&s1ap_UEContextReleaseComplete->s1ap_UEContextReleaseComplete_ies.list, ie);
    }
...
int s1ap_encode_s1ap_uecontextreleaserequesties(
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_MME_UE_S1AP_ID,
                        S1ap_Criticality_reject,
                        &asn_DEF_S1ap_MME_UE_S1AP_ID,
                          &s1ap_UEContextReleaseRequestIEs->mme_ue_s1ap_id)) == NULL) {
        return -1;
    }
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_eNB_UE_S1AP_ID,
                        S1ap_Criticality_reject,
                        &asn_DEF_S1ap_ENB_UE_S1AP_ID,
                          &s1ap_UEContextReleaseRequestIEs->eNB_UE_S1AP_ID)) == NULL) {
        return -1;
    }
    ASN_SEQUENCE_ADD(&s1ap_UEContextReleaseRequest->s1ap_UEContextReleaseRequest_ies.list, ie);
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_Cause,
                        S1ap_Criticality_ignore,
                        &asn_DEF_S1ap_Cause,
                          &s1ap_UEContextReleaseRequestIEs->cause)) == NULL) {
        return -1;
    }
    ASN_SEQUENCE_ADD(&s1ap_UEContextReleaseRequest->s1ap_UEContextReleaseRequest_ies.list, ie);
    ...
    if (s1ap_UEContextReleaseRequestIEs->presenceMask & S1AP_UECONTEXTRELEASEREQUESTIES_GWCONTEXTRELEASEINDICATION_PRESENT) {
        if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_GWContextReleaseIndication,
                            ...
                            &s1ap_UEContextReleaseRequestIEs->gwContextReleaseIndication)) == NULL) {
            return -1;
        }
        ASN_SEQUENCE_ADD(&s1ap_UEContextReleaseRequest->s1ap_UEContextReleaseRequest_ies.list, ie);
    }
...
int s1ap_encode_s1ap_uplinknastransporties(
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_MME_UE_S1AP_ID,
                        S1ap_Criticality_reject,
                        &asn_DEF_S1ap_MME_UE_S1AP_ID,
                          &s1ap_UplinkNASTransportIEs->mme_ue_s1ap_id)) == NULL) {
        return -1;
    }
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_eNB_UE_S1AP_ID,
                        S1ap_Criticality_reject,
                        &asn_DEF_S1ap_ENB_UE_S1AP_ID,
                          &s1ap_UplinkNASTransportIEs->eNB_UE_S1AP_ID)) == NULL) {
        return -1;
    }
    ASN_SEQUENCE_ADD(&s1ap_UplinkNASTransport->s1ap_UplinkNASTransport_ies.list, ie);
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_NAS_PDU,
                        S1ap_Criticality_reject,
                        &asn_DEF_S1ap_NAS_PDU,
                          &s1ap_UplinkNASTransportIEs->nas_pdu)) == NULL) {
        return -1;
    }
    ASN_SEQUENCE_ADD(&s1ap_UplinkNASTransport->s1ap_UplinkNASTransport_ies.list, ie);
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_EUTRAN_CGI,
                        S1ap_Criticality_ignore,
                        &asn_DEF_S1ap_EUTRAN_CGI,
                          &s1ap_UplinkNASTransportIEs->eutran_cgi)) == NULL) {
        return -1;
    }
    ASN_SEQUENCE_ADD(&s1ap_UplinkNASTransport->s1ap_UplinkNASTransport_ies.list, ie);
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_TAI,
                        S1ap_Criticality_ignore,
                        &asn_DEF_S1ap_TAI,
                          &s1ap_UplinkNASTransportIEs->tai)) == NULL) {
        return -1;
    }
    ASN_SEQUENCE_ADD(&s1ap_UplinkNASTransport->s1ap_UplinkNASTransport_ies.list, ie);
    ...
    if (s1ap_UplinkNASTransportIEs->presenceMask & S1AP_UPLINKNASTRANSPORTIES_GW_TRANSPORTLAYERADDRESS_PRESENT) {
        if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_GW_TransportLayerAddress,
                            S1ap_Criticality_ignore,
                            &asn_DEF_S1ap_TransportLayerAddress,
                            &s1ap_UplinkNASTransportIEs->gW_TransportLayerAddress)) == NULL) {
            return -1;
        }
        ASN_SEQUENCE_ADD(&s1ap_UplinkNASTransport->s1ap_UplinkNASTransport_ies.list, ie);
    }
...
int s1ap_encode_s1ap_uecontextreleasecommandies(
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_UE_S1AP_IDs,
                        ...
                        &asn_DEF_S1ap_UE_S1AP_IDs,
                          &s1ap_UEContextReleaseCommandIEs->uE_S1AP_IDs)) == NULL) {
        return -1;
    }
    ...
    if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_Cause,
                        S1ap_Criticality_ignore,
                        &asn_DEF_S1ap_Cause,
                          &s1ap_UEContextReleaseCommandIEs->cause)) == NULL) {
        return -1;
    }
    ASN_SEQUENCE_ADD(&s1ap_UEContextReleaseCommand->s1ap_UEContextReleaseCommand_ies.list, ie);
...
int s1ap_encode_s1ap_e_rabinformationlist(
    ...
    for (i = 0; i < s1ap_E_RABInformationListIEs->s1ap_E_RABInformationItem.count; i++) {
        if ((ie = s1ap_new_ie(S1ap_ProtocolIE_ID_id_E_RABInformationListItem,
                            ...
                            s1ap_E_RABInformationListIEs->s1ap_E_RABInformationItem.array[i])) == NULL) {
            return -1;
        }
