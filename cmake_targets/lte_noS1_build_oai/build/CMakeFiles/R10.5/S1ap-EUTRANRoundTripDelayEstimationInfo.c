...
asn_comp_rval_t * 
S1ap_EUTRANRoundTripDelayEstimationInfo_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	S1ap_EUTRANRoundTripDelayEstimationInfo_1_inherit_TYPE_descriptor(td1);
	S1ap_EUTRANRoundTripDelayEstimationInfo_1_inherit_TYPE_descriptor(td2);
