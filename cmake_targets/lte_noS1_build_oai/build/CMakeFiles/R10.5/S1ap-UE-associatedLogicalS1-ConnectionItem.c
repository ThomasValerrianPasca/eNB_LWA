...
static int asn_MAP_S1ap_UE_associatedLogicalS1_ConnectionItem_oms_1[] = { 0, 1, 2 };
static ber_tlv_tag_t asn_DEF_S1ap_UE_associatedLogicalS1_ConnectionItem_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_S1ap_UE_associatedLogicalS1_ConnectionItem_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mME-UE-S1AP-ID at 1351 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* eNB-UE-S1AP-ID at 1352 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* iE-Extensions at 1354 */
};
