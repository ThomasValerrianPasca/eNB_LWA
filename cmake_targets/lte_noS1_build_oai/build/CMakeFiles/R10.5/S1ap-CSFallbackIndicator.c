...
asn_comp_rval_t * 
S1ap_CSFallbackIndicator_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	S1ap_CSFallbackIndicator_1_inherit_TYPE_descriptor(td1);
	S1ap_CSFallbackIndicator_1_inherit_TYPE_descriptor(td2);
...
static asn_INTEGER_enum_map_t asn_MAP_S1ap_CSFallbackIndicator_value2enum_1[] = {
	{ 0,	20,	"cs-fallback-required" },
	{ 1,	25,	"cs-fallback-high-priority" }
	/* This list is extensible */
};
static unsigned int asn_MAP_S1ap_CSFallbackIndicator_enum2value_1[] = {
	1,	/* cs-fallback-high-priority(1) */
	0	/* cs-fallback-required(0) */
	/* This list is extensible */
};
static asn_INTEGER_specifics_t asn_SPC_S1ap_CSFallbackIndicator_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_S1ap_CSFallbackIndicator_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_S1ap_CSFallbackIndicator = {
	...
	S1ap_CSFallbackIndicator_compare,
